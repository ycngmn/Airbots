...
# Minor bugs fixed. '.captcha-saves'
# Original Source : https://github.com/SwissCorePy/pyTelegramBotCAPTCHA
...
_captcha_saves = (Path(".") / ".captcha-saves").absolute()
_fonts = []
...
captcha_generator = CaptchaGenerator(captcha_size_num=3)  # 1 = (426, 240)
